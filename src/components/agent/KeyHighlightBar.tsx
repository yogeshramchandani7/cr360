...
interface KeyHighlightBarProps {
  text: string;
...
/**
 * KeyHighlightBar - Informational bar showing key takeaway for charts
 * Displays above evidence charts to help users quickly understand what to look for
 */
export default function KeyHighlightBar({
  text,
  variant = 'neutral',
  icon = 'alert-circle'
}: KeyHighlightBarProps) {
  // Get icon component
  const getIcon = () => {
